...
<i class='bx bx-search' onclick="on"></i>
</button>
</div>
</form>
</div>
...
<li class="nav-item">
<a href="index-2.php" class="nav-link active">Home Demo Two</a>
</li>
<li class="nav-item">
...
<div class="inner">
<h3><span class="percent">20%</span> Black Friday <span>Sale</span></h3>
...
<img src="assets/images/products/products14.png" alt="Products">
<div class="inner">
<h3>
...
<div class="bottom">
<a class="cart-text" href="javascript:;" onclick="on('1')">Add To Cart</a>
<input type="hidden" id="price1_val" value="price $200.00"/>
<input type="hidden" id="item1_val" value="1"/>
<input type="hidden" id="quant1_val" value="0"/>
<i class='bx bx-plus' id="item1"></i>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-3">
...
<img src="assets/images/products/products15.png" alt="Products">
<div class="inner">
<h3>
<a href="single-product.html">Corsair Gaming Keyboard</a>
</h3>
<span id="price">$180.00</span>
</div>
</div>
 <div class="bottom">
<a class="cart-text" href="javascript:;" onclick="on('2')">Add To Cart</a>
<input type="hidden" id="price2_val" value="price $180.00"/>
<input type="hidden" id="item2_val" value="2"/>
<input type="hidden" id="quant2_val" value="0"/>
<i class='bx bx-plus'id="item2"></i>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-3">
...
<img src="assets/images/products/products16.png" alt="Products">
<div class="inner">
<h3>
<a href="single-product.html">Apple MacBook Air 13.3-Inch</a>
</h3>
<span >$170.00</span>
</div>
</div>
<div class="bottom">
<a class="cart-text" href="javascript:;" onclick="on('3')">Add To Cart</a>
<input type="hidden" id="price3_val" value="price $170.00"/>
<input type="hidden" id="item3_val" value="3"/>
<input type="hidden" id="quant3_val" value="0"/>
<i class='bx bx-plus'id="item3"></i>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-3">
...
<img src="assets/images/products/products17.png" alt="Products">
<div class="inner">
<h3>
<a href="single-product.html">Apple iMac 27", Core i5</a>
</h3>
<span>$190.00</span>
</div>
</div>
<div class="bottom">
<a class="cart-text" href="javascript:;" onclick="on('4')">Add To Cart</a>
<input type="hidden" id="price4_val" value="price $190.00"/>
<input type="hidden" id="item4_val" value="4"/>
<input type="hidden" id="quant4_val" value="0"/>
<i class='bx bx-plus' id="item4"></i>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-3">
...
<img src="assets/images/products/products18.png" alt="Products">
<div class="inner">
<h3>
<a href="single-product.html">Canon EF-S 18-55mm Lens</a>
</h3>
<span>$160.00</span>
</div>
</div>
<div class="bottom">
<a class="cart-text" href="javascript:;" onclick="on('5')">Add To Cart</a>
<input type="hidden" id="price5_val" value="price $160.00"/>
<input type="hidden" id="item5_val" value="5"/>
<input type="hidden" id="quant5_val" value="0"/>
<i class='bx bx-plus' id="item5"></i>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-3">
...
<img src="assets/images/products/products19.png" alt="Products">
<div class="inner">
<h3>
...
<div class="bottom">
<a class="cart-text" href="javascript:;" onclick="on('6')">Add To Cart</a>
<input type="hidden" id="price6_val" value="price $120.00"/>
<input type="hidden" id="item6_val" value="6"/>
<input type="hidden" id="quant6_val" value="0"/>
<i class='bx bx-plus'id="item6"></i>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-3">
...
<img src="assets/images/products/products20.png" alt="Products">
<div class="inner">
<h3>
...
<div class="bottom">
<a class="cart-text" href="javascript:;" onclick="on('7')">Add To Cart</a>
<input type="hidden" id="price7_val" value="price $250.00"/>
<input type="hidden" id="item7_val" value="7"/>
<input type="hidden" id="quant7_val" value="0"/>
<i class='bx bx-plus'id="item7"></i>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-3">
...
<img src="assets/images/products/products21.png" alt="Products">
<div class="inner">
<h3>
...
<div class="bottom">
<a class="cart-text" href="javascript:;" onclick="on('8')">Add To Cart</a>
<input type="hidden" id="price8_val" value="price $210.00"/>
<input type="hidden" id="item8_val" value="8"/>
<input type="hidden" id="quant8_val" value="0"/>
<i class='bx bx-plus'id="item8"></i>
</div>
</div>
</div>
</div>
...
<img src="assets/images/products/products22.png" alt="Products">
<div class="inner">
<h3>
<a href="single-product.html">Bionic Thunder Headphones</a>
</h3>
<span>$200.00</span>
</div>
</div>
...
<img src="assets/images/products/products23.png" alt="Products">
<div class="inner">
<h3>
<a href="single-product.html">Xiaomi A1821 Smart Watch</a>
</h3>
<span>$180.00</span>
</div>
</div>
...
<img src="assets/images/products/products24.png" alt="Products">
<div class="inner">
<h3>
<a href="single-product.html">Nikon D5600 DSLR Camera</a>
</h3>
<span>$170.00</span>
</div>
</div>
...
<img src="assets/images/products/products25.png" alt="Products">
<div class="inner">
<h3>
...
<div class="bottom">
<h3>
<a href="blog-details.html">How To Choose The Best Smartphone For Your Daily Task?</a>
</h3>
...
<div class="bottom">
<h3>
<a href="blog-details.html">How Does This VR Box Help In Children's Online Education?</a>
</h3>
<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia recusandae praesentium dolor atque debitis aspernatur quaerat</p>
<a class="blog-btn" href="blog-details.html">
Read More
...
<div class="bottom">
<h3>
<a href="blog-details.html">Find Out The Top Gaming Laptops Within The Best Pricing!</a>
</h3>
<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia recusandae praesentium dolor atque debitis aspernatur quaerat</p>
<a class="blog-btn" href="blog-details.html">
Read More
...
<a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#fd9598919192bd989e928dd39e9290"><span class="__cf_email__" data-cfemail="462e232a2a2906232529366825292b">[email&#160;protected]</span></a>
<a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#f990979f96b99c9a9689d79a9694"><span class="__cf_email__" data-cfemail="99f0f7fff6d9fcfaf6e9b7faf6f4">[email&#160;protected]</span></a>
</li>
</ul>
</div>
</div>
